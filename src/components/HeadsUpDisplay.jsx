...
export default function HeadsUpDisplay() {
  ...
  return (
    <div className="absolute top-0 left-0 w-full h-full pointer-events-none z-30">
      ...
      {/* Minimal Layer 1 */}
      <div ref={layer1} className="absolute bottom-[15vh] left-[8vw] max-w-md opacity-0 flex space-x-8 bg-basalt/30 backdrop-blur-md p-8 rounded-xl border border-white/10 shadow-lg items-stretch">
        <div className="w-[2px] bg-terracotta/80 shadow-[0_0_8px_rgba(184,93,59,0.5)] rounded-full"></div>
        <div className="py-2">
          <div className="font-mono text-terracotta text-[10px] tracking-[0.3em] mb-2 drop-shadow-md mt-1">PHASE 01 / CHASSIS</div>
      ...
      {/* Minimal Layer 2 */}
      <div ref={layer2} className="absolute bottom-[15vh] left-[8vw] max-w-md opacity-0 flex space-x-8 bg-basalt/30 backdrop-blur-md p-8 rounded-xl border border-white/10 shadow-lg items-stretch">
        <div className="w-[2px] bg-terracotta/80 shadow-[0_0_8px_rgba(184,93,59,0.5)] rounded-full"></div>
        <div className="py-2">
          <div className="font-mono text-terracotta text-[10px] tracking-[0.3em] mb-2 drop-shadow-md mt-1">PHASE 02 / CRYSTAL</div>
      ...
      {/* Minimal Layer 3 */}
      <div ref={layer3} className="absolute bottom-[15vh] right-[8vw] max-w-md opacity-0 flex space-x-8 text-right justify-end bg-basalt/30 backdrop-blur-md p-8 rounded-xl border border-white/10 shadow-lg items-stretch">
        <div className="py-2">
          <div className="font-mono text-terracotta text-[10px] tracking-[0.3em] mb-2 drop-shadow-md mt-1">PHASE 03 / MOVEMENT</div>
